            ...
            <div v-if="!loading" class="flex flex-col gap-y-4 pb-4">
                ...
                <div class="flex flex-col gap-y-2">
                    <div class="carousel carousel-center w-full px-4 space-x-2">
                        <Tab 
                            ...
                            :title="product.price_subscription ? product.platform === 'PS' ? 'без PS Plus' : 'без Game Pass' : false"
                        ...
                        <Tab 
                            v-else-if="product.price_standart"
                            :title="(product.price_subscription && sale_prices) ? product.platform === 'PS' ? 'без PS Plus' : 'без Game Pass' : false"
                        ...
                        <Tab
                            ...
                            :title="product.platform === 'PS' ? 'с PS Plus' : 'с Game Pass'"
                    ...
                    <span v-if="product.sale_date_end && sale_prices" class="px-4 text-sm text-hint_color">Скидка до {{ product.sale_date_end }}</span>
                </div>
                ...
                <div v-if="product.price_subscription" class="flex px-4 w-full">
                    <div class="bg-[#9D9D9D] w-full flex flex-col rounded-xl px-4 py-2.5">
                        ...
                        <p v-if="product.platform === 'Xbox'" class="text-black text-sm">Покупка по цене «с Game Pass» возможна, если на вашем аккаунте есть подписка Game Pass</p>
                        <p v-if="product.platform === 'PS'" class="text-black text-sm">Покупка по цене «с PS Plus» возможна, если на вашем аккаунте есть подписка PlayStation Plus</p>
                    </div>
                </div>
